...
export const convertToMp3 = createTool({
  id: 'convertToMp3',
  description: 'Convert any media file at a public URL to MP3 audio.',
  ...
  execute: async ({ mediaUrl, bitrate, webhookUrl, requestId }) => {
    const body = {
      media_url: mediaUrl,
      ...(bitrate && { bitrate }),
